...
@section('page-header', sprintf('Actualizare %s', $book->title))
...
<form class="py-5" action="{{ route('books.update', $book->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="author" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $book->author }}">
    ...
    <div class="mb-3">
        ...
        <div class="input-group date" data-provide="datepicker" >
            <input type="text" class="form-control" name="published_at" value="{{ $book->published_at->format('d-m-Y') }}">
    ...
    <button type="submit" class="btn btn-success float-end">Actualizeaza</button>
</form>
@endsection
